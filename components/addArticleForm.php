...
<form action="addArticle.php" method="POST" enctype="multipart/form-data" class="p-4 border rounded shadow-lg bg-light">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control form-control-lg w-100" id="title" name="title" required>
    </div>
    <div class="mb-3">
        <label for="image" class="form-label fw-bold">انتخاب تصویر</label>
        <input type="file" class="form-control form-control-lg w-100" id="image" name="image" accept="image/*" required>
    </div>
    <div class="mb-3">
        <label for="content" class="form-label fw-bold">متن مقاله</label>
        <textarea class="form-control form-control-lg w-100" id="content" name="content" rows="5" required></textarea>
    </div>
    <div class="mb-3">
        <label for="author" class="form-label fw-bold">نویسنده</label>
        <input type="text" class="form-control form-control-lg w-100" id="author" name="author" value="امیرحسین بهرامی" required>
    </div>
    <div class="mb-3">
        <label for="date" class="form-label fw-bold">تاریخ</label>
        <input type="date" class="form-control form-control-lg w-100" id="date" name="date" required>
    </div>
